...
from version_handler import check_and_upgrade_report, check_industry_version_upgrade
...
def main():
    ...
    financial_metrics = calculate_financial_metrics(
        df_emp, df_stock, advertising_budget, gross_income)
    ...
    if not df_industry.empty:
        check_industry_version_upgrade(sheet_name_str, INDUSTRY_DB_PATH)
